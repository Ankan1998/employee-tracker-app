...
import 'package:flutter_assignment_app/custom_widget/save_cancel_bottom_widget.dart';
import 'package:flutter_assignment_app/pages/add_edit_page/widgets/end_date_header_widget.dart';
import 'package:flutter_assignment_app/pages/add_edit_page/widgets/start_date_header_widget.dart';
      ...
      children: <Widget>[
        widget.isEndDate
            ...
            : StartDateHeder(
                ...
                onPressedNextMonday: () {
                  setState(() {
                    _selectedDate = HelperUtil.getNextWeekday(
                        _selectedDate, DateTime.monday);
                  });
                },
                onPressedNextTuseday: () {
                  setState(() {
                    _selectedDate = HelperUtil.getNextWeekday(
                        _selectedDate, DateTime.tuesday);
                  });
                },
                onPressedAfterWeek: () {
                  setState(() {
